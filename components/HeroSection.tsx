                ...
                <div className="max-w-6xl mx-auto">
                  ...
                  >
                    <a
                      ...
                      className="group relative inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white text-base font-semibold rounded-full transition-all duration-500 shadow-2xl hover:shadow-emerald-500/25 hover:scale-105 transform overflow-hidden"
                    >
                      ...
                      <svg
                        className="w-4 h-4 ml-3 transition-transform duration-500 group-hover:translate-x-1 relative z-10"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <a
                      href="#solucoes"
                      className="group inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur-md text-white text-base font-medium rounded-full border-2 border-white/30 hover:bg-white/20 hover:border-white/50 transition-all duration-500"
                    >
                      <span>Saiba mais</span>
                      <svg
                        className="w-4 h-4 ml-3 transition-transform duration-500 group-hover:translate-y-1"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
